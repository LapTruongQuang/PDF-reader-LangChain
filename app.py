...
async def on_message(message: cl.Message):
    ...
    # Get the source documents. Nếu bạn muốn hiển thị nhiều hơn một tài liệu nguồn, bạn có thể thêm chúng vào đây.
    #Không thì ta có thể ẩn đi
    source_documents = res["source_documents"]
    text_elements = [] #Cần phải có dòng này để hiển thị source, nếu không cần source thì nên hiểu biến này sẽ rỗng sẽ không hiển thị gì cả
